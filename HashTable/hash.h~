...
/**
 * @file hash.h
 * @brief Header file for hash.cpp
 *
 * @author Pinak Das
 * @date 3/30/16
 */
...
// do not change anything above!
  int getlongestList();                          // track longest list
  double getRunningAvgListLength();  // compute running average list length
  double getLoadFactor();                   // calculate load factor
};
